...
class _ChatMessageScreenState extends State<ChatMessageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    chatController.loadMessages(chat: args['chat_model']);
        ...
        child: GetBuilder<ChatController>(
          builder: (controller) {
            ...
            return Column(
              ...
              children: [
                Visibility(
                  visible: controller.isMessageLoading,
                        ...
                        return Column(
                          children: [
                            ...
                            MessageBubble(
                              ...
                              isMe: message['userId'] == '658b90d4312b6cda7c4810a9',
                            ),
                          ],
                        );
                      },
